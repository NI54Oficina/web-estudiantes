...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo" style="background-image:radial-gradient(ellipse at center, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.75) 100%),url('<?php echo url_site(); ?>/img/textura.png'); background-repeat:repeat">
    	<div class="grid grid-pad">
